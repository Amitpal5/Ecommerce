  ...
  <body>
   ...
   @include('admin.page.navbar')
    ...
    <!-- ########## START: MAIN PANEL ########## -->
        ...
        <span class="breadcrumb-item active">Delivery Man Order</span>
      </nav>
	    ...
	    <div class="table-wrapper">
			...
			@endif</td>
              ...
              <td>
			  	...
			  	<a href="{{route('admin.deliveryman.accept',['id'=>$value->id,'order_id' =>$value->order_id])}}"><i class="fa fa-edit" style="font-size:25px;"></i></a>
