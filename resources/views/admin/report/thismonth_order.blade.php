  ...
  <body>
   ...
   @include('admin.page.navbar')
    ...
    <!-- ########## START: MAIN PANEL ########## -->
        ...
        <span class="breadcrumb-item active">This Month Delivery Order</span>
      </nav>
	  ...
	  <div class="row">
	  <div class="col-md-9">
	   <h5>This Month Order List</h5>
	   <h3 style="color:red">This Month Total Delivery {{$sub_total}} TK</h3>
	   </div>
	    ...
	    <div class="table-wrapper">
			...
			@endif</td>
              ...
              <td>
			  	...
			  	<a href="{{route('admin.viewsucced.accept',['id'=>$value->id,'order_id' =>$value->order_id])}}"><i class="fa fa-edit" style="font-size:25px;"></i></a>
