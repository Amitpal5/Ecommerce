            ...
            <div class="container">
                ...
                <div class="breadcrumb-content text-center">
                    ...
                    <ul>
                        ...
                        <li class="active">{{$data->SubCatagory_name}}</li>
						@endforeach
                    </ul>
                </div>
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                            ...
                                            <div class="single-product-wrap mb-35">
                                                ...
                                                <div class="product-img product-img-zoom mb-15">
                                                    <a href="{{url('/single_product',$subs->id)}}">
                                                        <img src="{{asset($subs->image_1)}}" alt="">
                                                    </a>
                                                ...
                                                <div class="product-content-wrap-2 text-center">
                                                    ...
                                                    <h3><a href="{{url('/single_product',$subs->id)}}">{{$subs->product_name}}</a></h3>
                                            ...
                                            <button class="addcart" data-id="{{$subs->id}}">Add To Cart</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
